...
public class ChatsFragment extends Fragment {
                                ...
                                if (dataSnapshot.exists()) {
                                    if (dataSnapshot.hasChild("image")) {
                                        ...
                                        Picasso.get().load(retImage[0]).networkPolicy(NetworkPolicy.OFFLINE)
                                                .placeholder(R.drawable.profile).into(chatViewHolder.profileImage, new Callback() {
                                            @Override
                                            ...
                                            public void onError(Exception e) {
                                                Picasso.get().load(retImage[0]).placeholder(R.drawable.profile).into(chatViewHolder.profileImage);
    ...
    public static class ChatViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChatViewHolder(@NonNull View itemView) {
            ...
            lastSeen = itemView.findViewById(R.id.user_last_seen);
        }
    }

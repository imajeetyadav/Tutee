...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void InitializeFields() {
        ...
        userProfileBio=(TextView)findViewById(R.id.visit_user_bio);
        sendMessageRequestButton = (Button) findViewById(R.id.send_message_request_button);
        declineMessageChatRequest = (Button) findViewById(R.id.decline_message_request_button);
        current_State = "new";
        ...
        userRef.child(receiverUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if ((dataSnapshot.exists()) && dataSnapshot.hasChild("image")) {
                    ...
                    Picasso.get().load(userProfile).placeholder(R.drawable.profile).into(userProfileImage);
